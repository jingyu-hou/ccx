...
!     
      subroutine applyboun_cast(nodeboun,ndirboun,nboun,xbounact,
     &     ithermal,nk,iponoel,inoel,vold,vcontu,t1act,isolidsurf,
     &     nsolidsurf,xsolidsurf,nfreestream,ifreestream,iturbulent,
     &     vcon,shcon,nshcon,rhcon,nrhcon,flcon,nflcon,srhocp,nsrhocp,
     &     lh,ielmat,ntmat_,physcon,v,compressible,ismooth,nmpc,nodempc,
     &     ipompc,coefmpc,inomat,mi,ikboun,ilboun,ilmpc,labmpc)
!     
...
!     
     ...
     &     shcon(0:3,ntmat_,*),flcon(0:1,ntmat_,*),
...
!     
        if(node.ne.nref) then
          if(nref.ne.0) then
            call phys2con_cast(inomat,nref,vold,ntmat_,shcon,nshcon,
     &           physcon,compressible,vcon,rhcon,nrhcon,
     &           flcon,nflcon,srhocp,nsrhocp,lh,ithermal,mi)
          endif
          nref=node
        endif
!     
