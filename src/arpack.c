...
void arpack(double *co, ITG *nk, ITG **konp, ITG **ipkonp, char **lakonp,
	     ...
	     ITG *ielprop,double *prop,char *orname,double *mpcon,
  ...
  ITG *inum=NULL,k,ido,ldz,iparam[11],ipntr[14],lworkl,ngraph=1,im,
    ...
    *iponoel=NULL,*inoel=NULL,nrhs=1,singularflag;
  ...
  double *stn=NULL,*v=NULL,*resid=NULL,*z=NULL,*workd=NULL,
    ...
    *cdnr=NULL,*cdni=NULL,*eme=NULL,*rdpcon=NULL,*gscon=NULL;
  ...
  if(*iperturb==0){
     results(co,nk,kon,ipkon,lakon,ne,v,stn,inum,stx,
	     ...
	     islavsurf,ielprop,prop,energyini,energy,&kscale,iponoel,
             inoel,nener,orname,&network,ipobody,xbody,ibody,mpcon,
  ...
  if(*iperturb==0){
    mafillsmmain(co,nk,kon,ipkon,lakon,ne,nodeboun,ndirboun,xboun,nboun,
	      ...
	      t0,t0,ithermal,prestr,iprestr,vold,vini,iperturb,sti,
      ...
      mafillsmmain(co,nk,kon,ipkon,lakon,ne,nodeboun,ndirboun,xboun,nboun,
	      ...
	      elcon,nelcon,rhcon,nrhcon,alcon,nalcon,alzero,ielmat,
	      ielorien,norien,orab,ntmat_,
	      t0,t1old,ithermal,prestr,iprestr,vold,vini,iperturb,sti,
	      nzs,stx,adb,aub,iexpl,plicon,nplicon,plkcon,nplkcon,
	      xstiff,npmat_,&dtime,matname,mi,
              ncmat_,mass,&stiffness,&buckling,&rhsi,&intscheme,
              physcon,shcon,nshcon,cocon,ncocon,ttime,&time,istep,&iinc,
