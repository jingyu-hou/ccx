...
!     
      subroutine basis_cfdfem(x,y,z,xo,yo,zo,nx,ny,nz,planfa,ifatet,
     &     nktet,netet,field,nfield,cotet,kontyp,ipkon,kon,iparent,xp,
     &     yp,zp,value,ratio,iselect,nselect,istartset,iendset,ialset,
...
!     kontyp(i)       type of parent element i
