...
!
      subroutine con2phys_cast(vold,vcon,v,nk,
     &  ielmat,ntmat_,shcon,nshcon,rhcon,nrhcon,flcon,nflcon,
     &  htcon,nhtcon,srhocp,nsrhocp,lh,iout,nmethod,convergence,
     &  physcon,iponoel,inoel,ithermal,nactdoh,iit,compressible,
     &  ismooth,vcontu,vtu,turbulent,inomat,nodeboun,ndirboun,nboun,
     &  mi,co,factor,tempold)
!
...
!
     ...
     &  vcontu(2,*),vtu(2,*),co(3,*),factor,flcon(0:1,ntmat_,*),
     &  htcon(0:1,101,*),lh,entha,srhocp(0:1,2*ntmat_,*),
     &  tempold(*)
!
...
!     
               do
c                  call materialdata_cp_sec(imat,ntmat_,temp,shcon,
c     &                 nshcon,cp,physcon)
...
c                  print *,"con2phys: node",i,"H=",entha,"T=",temp
!******************************************************************
!
                  j=j+1
                  if((dabs(temp-temp0).lt.1.d-4*dabs(temp)).or.
