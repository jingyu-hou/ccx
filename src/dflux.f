...
!
!
c      flux(1)=(sti(1,npt,noel)*
c     &            (xstate(2,npt,noel)-xstateini(2,npt,noel))+
c     &         sti(2,npt,noel)*
c     &            (xstate(3,npt,noel)-xstateini(3,npt,noel))+
c     &         sti(3,npt,noel)*
c     &            (xstate(4,npt,noel)-xstateini(4,npt,noel))+
c     &   2.d0*(sti(4,npt,noel)*
c     &            (xstate(5,npt,noel)-xstateini(5,npt,noel))+
c     &         sti(5,npt,noel)*
c     &            (xstate(6,npt,noel)-xstateini(6,npt,noel))+
c     &         sti(6,npt,noel)*
c     &            (xstate(7,npt,noel)-xstateini(7,npt,noel))))/
c     &         dtime
      
      
      flux(1)=0.9d0*xstateini(10,npt,noel)/dtime
