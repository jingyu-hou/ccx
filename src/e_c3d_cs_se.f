...
!
     ...
     &  istartelem,ialelem,v,sigma,nk,mpcon,nmpcon,nmpmat_)
!
...
!
     ...
     &  istartelem(*),ialelem(*),nk,idesloc,nmpcon(2,*),nmpmat_
!
     ...
     &  vl(0:mi(2),52),v(0:mi(2),*),mpcon(2,nmpmat_,*),mpconloc(800)
!
...
!
     ...
     &              nelem,mpcon,nmpcon,nmpmat_,mpconloc)
            elseif(mortar.eq.1) then
...
!
     ...
     &        nplicon,plkcon,nplkcon,npmat_,
     &        plconloc,mi(1),dtime,kk,
     &        dxstiff(1,1,1,idir),ncmat_,xstate,nstate_,mpcon,nmpcon,
     &        nmpmat_,mpconloc)
         endif
!
         if(mattyp.eq.1) then
