...
!
     ...
     &  istartelem,ialelem,v,sigma,ieigenfrequency,mpcon,nmpcon,nmpmat_)
!
...
!
     ...
     &  vl(0:mi(2),26),v(0:mi(2),*),mpcon(2,nmpmat_,*),mpconloc(800)
!
...
!
     ...
     &        nplicon,plkcon,nplkcon,npmat_,
     &        plconloc,mi(1),dtime,kk,
     &        dxstiff(1,1,1,idir),ncmat_,xstate,nstate_,
     &        mpcon,nmpcon,nmpmat_,mpconloc)
         endif
!
         if(mattyp.eq.1) then
