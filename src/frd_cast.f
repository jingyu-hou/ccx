...
!
      subroutine frd_cast(kode,time,nk,mi,inomat,vold,flcon,nflcon,
...
!
      ...
      character*132 text
!
      integer kode,nk,mi(*),inomat(*),nflcon(*),ntmat_,ithermal(*),
     &        nout,i,istep,iinc,icounter
!
      real*8 time,vold(0:mi(2),*),flcon(0:1,ntmat_,*),temp,fl
!
      save nout
!
      m1=' -1'
...
!
      do i=1,nk
         if(inomat(i).le.0) cycle
         temp=vold(0,i)
         call materialdata_temp2fl(flcon,nflcon,inomat(i),fl,
     &        temp,ntmat_,ithermal)         
         write(13,100) m1,i,1.d0-fl
      enddo
!
      write(13,'(a3)') m3
!
