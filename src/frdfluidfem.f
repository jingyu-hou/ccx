...
c        write(13,'(a5,a1)') p1,c
        ...
        write(13,'(a5,''UPGM               WeICME'')') p1
        write(13,'(a5,''UVERSION           Version 2020'')') p1
        write(13,'(a5,''UCOMPILETIME       2021年 03月 '')') p1
        write(13,'(a5,''UDIR'')') p1
        write(13,'(a5,''UDBN'')') p1
!
...
c        write(13,'(a5,a1,67x,i1)') p2,c,one
        ...
        do i=1,nk
           ...
           nout=nout+1
        enddo
        write(13,'(a5,a1,t22,i15,t74,i1)') p2,c,nout,one
!
c        nout=0
        do i=1,nk
           if(inomat(i).le.0) cycle
...
!       20210318 material name is replaced by their serial number
!       for WeICME-GUI reading
!
c        write(13,'(a5,a1,67x,i1)') p3,c,one
        nelout=0
        do i=1,ne
           if(ipkon(i).lt.0) cycle
           nelout=nelout+1
        enddo
        write(13,'(a5,a1,t22,i15,t74,i1)') p3,c,nelout,one
!
        do i=1,ne
!
           if(ipkon(i).lt.0) cycle
...
c              write(13,'(a3,i10,3a5)') m1,i,p4,p0,
c     &                          matname(ielmat(1,i))(1:5)
              write(13,'(a3,i10,2a5,i5)') m1,i,p4,p0,ielmat(1,i)
...
c              write(13,'(a3,i10,3a5)')m1,i,p12,p0,
c     &                          matname(ielmat(1,i))(1:5)
              write(13,'(a3,i10,2a5,i5)')m1,i,p12,p0,ielmat(1,i)
              write(13,'(a3,3i10)') m2,kon(indexe+21),kon(indexe+23),
     &               kon(indexe+22)
              else
c              write(13,'(a3,i10,3a5)')m1,i,p10,p0,
c     &                          matname(ielmat(1,i))(1:5)
              write(13,'(a3,i10,2a5,i5)')m1,i,p10,p0,ielmat(1,i)
              write(13,'(a3,8i10)') m2,(kon(indexe+20+j),j=1,8)
              endif
           elseif(lakon(i)(4:4).eq.'8') then
c              write(13,'(a3,i10,3a5)') m1,i,p1,p0,
c     &                          matname(ielmat(1,i))(1:5)
              write(13,'(a3,i10,2a5,i5)')m1,i,p1,p0,ielmat(1,i)
              write(13,'(a3,8i10)') m2,(kon(indexe+j),j=1,8)
           elseif(lakon(i)(4:5).eq.'10') then
c              write(13,'(a3,i10,3a5)') m1,i,p6,p0,
c     &                          matname(ielmat(1,i))(1:5)
              write(13,'(a3,i10,2a5,i5)')m1,i,p6,p0,ielmat(1,i)
              write(13,'(a3,10i10)') m2,(kon(indexe+j),j=1,10)
           elseif(lakon(i)(4:4).eq.'4') then
c              write(13,'(a3,i10,3a5)') m1,i,p3,p0,
c     &                          matname(ielmat(1,i))(1:5)
              write(13,'(a3,i10,2a5,i5)')m1,i,p3,p0,ielmat(1,i)
              write(13,'(a3,4i10)') m2,(kon(indexe+j),j=1,4)
           elseif(lakon(i)(4:5).eq.'15') then
              if((lakon(i)(7:7).eq.' ')) then
c              write(13,'(a3,i10,3a5)') m1,i,p5,p0,
c     &                          matname(ielmat(1,i))(1:5)
              write(13,'(a3,i10,2a5,i5)')m1,i,p5,p0,ielmat(1,i)
              write(13,'(a3,10i10)') m2,(kon(indexe+j),j=1,9),
     &          kon(indexe+13)
              write(13,'(a3,5i10)') m2,(kon(indexe+j),j=14,15),
     &          (kon(indexe+j),j=10,12)
              else
c              write(13,'(a3,i10,3a5)') m1,i,p8,p0,
c     &                          matname(ielmat(1,i))(1:5)
              write(13,'(a3,i10,2a5,i5)')m1,i,p8,p0,ielmat(1,i)
              write(13,'(a3,6i10)') m2,(kon(indexe+15+j),j=1,6)
              endif
           elseif(lakon(i)(4:4).eq.'6') then
c              write(13,'(a3,i10,3a5)') m1,i,p2,p0,
c     &                          matname(ielmat(1,i))(1:5)
              write(13,'(a3,i10,2a5,i5)')m1,i,p2,p0,ielmat(1,i)
...
c              write(13,'(a3,i10,3a5)')m1,i,p11,p0,
c     &                          matname(ielmat(1,i))(1:5)
              write(13,'(a3,i10,2a5,i5)')m1,i,p11,p0,ielmat(1,i)
