...
!     
      subroutine initial_cast(yy,nk,co,ne,ipkon,kon,lakon,x,y,z,xo,yo,
     &     zo,nx,ny,nz,isolidsurf,neighsolidsurf,xsolidsurf,dh,nshcon,
     &     shcon,nrhcon,rhcon,nflcon,flcon,nsrhocp,srhocp,lh,vold,vcon,
     &     ntmat_,iponoel,inoel,iexplicit,ielmat,nsolidsurf,turbulent,
     &     physcon,compressible,matname,inomat,vcontu,mi,euler,ithermal,
     &     dhel)
!     
...
!     
     ...
     &     iplanew(2,6),nshcon(*),nrhcon(*),nflcon(*),ntmat_,neigh,
     &     nodel,ifacel,mi(*),ielmat(mi(3),*),imat,inomat(*),
     &     nonei20(3,12),nonei15(3,9),euler,ithermal(*),iexplicit,
     &     turbulent,iflag,konl(26),nopes,nfaces,ig,iplanet(4),
     &     nonei10(3,6),compressible,nsrhocp(*)
!     
      real*8 x(*),y(*),z(*),xo(*),yo(*),zo(*),xsolidsurf(*),xsj2(3),
     &     yy(*),co(3,*),dh(*),r,cp,rho,shcon(0:3,ntmat_,*),vcontu(2,*),
     &     rhcon(0:1,ntmat_,*),flcon(0:1,ntmat_,*),lh,vold(0:mi(2),*),
     &     vcon(0:4,*),px,py,pz,a,b,c,d,temp,vel,dtu,dtnu,physcon(*),
     &     xtu,xkin,dvi,dhel(*),xl2(3,9),xl(3,26),xs2(3,7),xi,et,ze,xsj,
     &     weight,volume,shp(4,26),shp2(7,9),factor,area,dhelmax,entha,
     &     srhocp(0:1,2*ntmat_,*)
!     
