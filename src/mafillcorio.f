...
!
     ...
     &  xstate,nstate_,mpcon,nmpcon,nmpmat_)
!
...
!
     ...
     &  nplicon(0:ntmat_,*),nplkcon(0:ntmat_,*),npmat_,nstate_,
     &  nmpcon(2,*),nmpmat_
!
...
!
     ...
     &  xstiff(27,mi(1),*),xstate(nstate_,mi(1),*),mpcon(2,nmpmat_,*)
!
...
!     
     ...
     &          nmethod,ielprop,prop,xstate,nstate_,
