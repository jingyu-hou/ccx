...
!
     ...
     &  freq,ndamp,dacon,mpcon,nmpcon,nmpmat_,rdpcon,gscon)
!
...
!
     ...
     &  nea,neb,kscale,ndof,ii,igauss,nmpcon(2,*),nmpmat_
!
     ...
     &  mpcon(2,nmpmat_,*),rdpcon(10,3,*),gscon(30,5,*)
!
     ...
     &  tieset,istartset,iendset,ialset,ntie,nasym,pslavsurf,pmastsurf,
     &  mortar,clearini,ielprop,prop,nea,neb,freq,mpcon,nmpcon,nmpmat_,
     &  rdpcon,gscon
!
