...
static ITG *nk1,*kon1,*ipkon1,*ne1,
    ...
    *neapar=NULL,*nebpar=NULL,*ndamp1,*nzs1,*nmpcon1,*nmpmat1_;
...
static double *co1,*coefmpc1,*xload1,*xbody1,*cgr1,
    ...
    *clearini1,*prop1,*freq1,*dacon1,*mpcon1,*rdpcon1,*gscon1;
...
// next line is to be inserted in a similar way for all other paralell parts
    ...
    mpcon1=mpcon;nmpcon1=nmpcon;nmpmat1_=nmpmat_;rdpcon1=rdpcon;gscon1=gscon;
...
void *mafilldmssmt(ITG *i){
    ...
    FORTRAN(mafilldmss,(co1,nk1,kon1,ipkon1,lakon1,ne1,
	    ...
	    &nea,&neb,freq1,ndamp1,dacon1,mpcon1,nmpcon1,nmpmat1_,rdpcon1,
	    gscon1));
