...
!
     ...
     &  iprestr,vold,vini,iperturb,sti,nzs,stx,adb,aub,iexpl,plicon,
...
!
     ...
     &  ff(60),fnext(0:mi(2),*),vini(0:mi(2),*),
...
!
     ...
     &  nrhcon,alcon,nalcon,alzero,ielmat,ielorien,norien,orab,ntmat_,
     &  t0,t1,ithermal,prestr,
     &  iprestr,vold,vini,iperturb,sti,nzs,stx,iexpl,plicon,
     &  nplicon,plkcon,nplkcon,xstiff,npmat_,dtime,
     &  matname,mi,ncmat_,mass,stiffness,buckling,rhsi,intscheme,
     &  physcon,shcon,nshcon,cocon,ncocon,ttime,time,istep,iinc,
...
!
     ...
     &  nstate_,network,ipobody,xbody,ibody,rdpcon,gscon)
!
        do jj=1,nope
!
          j=jj
