...
static double *co1,*xboun1,*coefmpc1,*xforc1,*xload1,*xbody1,*cgr1,
    ...
    *clearini1,*prop1,*fnext1=NULL,*mpcon1,*rdpcon1,*gscon1;
...
//    }
    ...
    iprestr1=iprestr;vold1=vold;vini1=vini;iperturb1=iperturb;sti1=sti;nzs1=nzs;
    ...
    nmpcon1=nmpcon;nmpmat1_=nmpmat_;rdpcon1=rdpcon;gscon1=gscon; 
...
void *mafillsmmt(ITG *i){
    ...
    ITG indexad,indexfext,indexadb,nea,neb,indexfnext,j;
...
/*	nedelta=(ITG)floor(*ne01/(double)num_cpus);
    ...
    FORTRAN(mafillsm,(co1,nk1,kon1,ipkon1,lakon1,ne1,nodeboun1,ndirboun1,
	    ...
	    t01,t11,ithermal1,prestr1,iprestr1,vold1,vini1,iperturb1,sti1,
	    ...
	    mpcon1,nmpcon1,nmpmat1_,rdpcon1,gscon1));
