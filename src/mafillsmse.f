...
!
     ...
     &  ieigenfrequency,mpcon,nmpcon,nmpmat_)
!
      implicit none
!
      character*8 lakon(*)
...
!
     ...
     &  stiffonly(2),coriolis,idesloc,nmpcon(2,*),nmpmat_
!
     ...
     &  df(*),dxstiff(27,mi(1),ne,*),v(0:mi(2),*),mpcon(2,nmpmat_,*)
!
...
!     
     ...
     &           ialelem,v,sigma,ieigenfrequency,mpcon,nmpcon,nmpmat_)
!     
