  ...
  *nline=0;
  ...
  do{
	...
	ichangesurfacebehavior=1;
      ...
      else if(strcmp1(&buff[0],"*DAMAGE")==0){
        FORTRAN(keystart,(&ifreeinp,ipoinp,inp,"MATERIAL",
                          nline,&ikey));
      }
      ...
      else if(strcmp1(&buff[0],"*DYNAMICRECRYSTALLIZATION")==0){
        FORTRAN(keystart,(&ifreeinp,ipoinp,inp,"MATERIAL",
                          nline,&ikey));
      }
      else if(strcmp1(&buff[0],"*ELASTIC")==0){
      ...
      else if(strcmp1(&buff[0],"*LIQUIDFRACTION")==0){
        FORTRAN(keystart,(&ifreeinp,ipoinp,inp,"MATERIAL",
                          nline,&ikey));
      }
      ...
      else if(strcmp1(&buff[0],"*METALPOWDER")==0){
        FORTRAN(keystart,(&ifreeinp,ipoinp,inp,"MATERIAL",
                          nline,&ikey));
      }
      ...
      else if(strcmp1(&buff[0],"*POWDERHARDENING")==0){
        FORTRAN(keystart,(&ifreeinp,ipoinp,inp,"MATERIAL",
                          nline,&ikey));
      }
      else if(strcmp1(&buff[0],"*RATE-DEPENDENTPLASTIC")==0){
        FORTRAN(keystart,(&ifreeinp,ipoinp,inp,"MATERIAL",
                          nline,&ikey));
      }
	...
	(*nset)+=2;
      ...
      else if(strcmp1(&buff[0],"*PHASECURVE")==0){
        FORTRAN(keystart,(&ifreeinp,ipoinp,inp,"MATERIAL",
                                     nline,&ikey));
      }
      else if(strcmp1(&buff[0],"*PHASEPROP")==0){
        FORTRAN(keystart,(&ifreeinp,ipoinp,inp,"MATERIAL",
                                     nline,&ikey));
      }
      else if(strcmp1(&buff[0],"*INCUBATIONPERIOD")==0){
        FORTRAN(keystart,(&ifreeinp,ipoinp,inp,"MATERIAL",
                                     nline,&ikey));
      }
      else if(strcmp1(&buff[0],"*PHASELATENTHEAT")==0){
        FORTRAN(keystart,(&ifreeinp,ipoinp,inp,"MATERIAL",
                                     nline,&ikey));
      }
      else if(strcmp1(&buff[0],"*PHASECTROL")==0){
        FORTRAN(keystart,(&ifreeinp,ipoinp,inp,"MATERIAL",
                                     nline,&ikey));
      }
      else if(strcmp1(&buff[0],"*PHASEZBF")==0){
        FORTRAN(keystart,(&ifreeinp,ipoinp,inp,"MATERIAL",
                                     nline,&ikey));
      }
      else if(strcmp1(&buff[0],"*PHASEGS")==0){
        FORTRAN(keystart,(&ifreeinp,ipoinp,inp,"MATERIAL",
                                     nline,&ikey));
      }
      else if(strcmp1(&buff[0],"*PHASEYS")==0){
        FORTRAN(keystart,(&ifreeinp,ipoinp,inp,"MATERIAL",
                                     nline,&ikey));
      }
      else if(strcmp1(&buff[0],"*PHASEHARDNESS")==0){
        FORTRAN(keystart,(&ifreeinp,ipoinp,inp,"MATERIAL",
                                     nline,&ikey));
      }
	...
	}else if(strcmp1(&buff[0],"*SOLIDIFICATION")==0){
	    if(ithermal[1]<2) ithermal[1]=ithermal[1]+2;
