...
static ITG *kon1,*ipkon1,*ne1,*nelcon1,*nrhcon1,*nalcon1,*ielmat1,*ielorien1,
    ...
    *icoordinate1,*ialdesi1,*neapar=NULL,*nebpar=NULL,*nmpcon1,*nmpmat1_;
...
static double *co1,*v1,*stx1,*elcon1,*rhcon1,*alcon1,*alzero1,*orab1,*t01,*t11,
    ...
    *sti1,*xdesi1,*mpcon1,*rdpcon1,*gscon1;
...
void results_se(double *co,ITG *nk,ITG *kon,ITG *ipkon,char *lakon,ITG *ne,
       ...
       ITG *ishapeenergy,double *mpcon,ITG *nmpcon, ITG *nmpmat_,double *rdpcon,
       double *gscon){
...
// next line is to be inserted in a similar way for all other paralell parts
	...
	mpcon1=mpcon;nmpcon1=nmpcon;nmpmat1_=nmpmat_;rdpcon1=rdpcon;
	gscon1=gscon;
	...
	if(((ithermal[0]<=1)||(ithermal[0]>=3))&&(intpointvarm==1)){
		...
		iprestr,eme,iperturb,fn,iout,vold,nmethod,
	        ...
	        fn0,sti,icoordinate,dxstiff,ialdesi,xdesi,mpcon,nmpcon,
		nmpmat_,rdpcon,gscon));
	}
