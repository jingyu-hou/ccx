...
static double *co1,*v1,*elcon1,*rhcon1,*alcon1,*orab1,*t01,
    ...
    *xloadold1,*h01,*pslavsurf1,*pmastsurf1,*clearini1,*xbody1,*mpcon1,
    *pphase1,*cphase1,*phaseother1,*rdpcon1,*gscon1;
...
//    mpcon1=mpcon,nmpcon1=nmpcon,nmpmat1_=nmpmat_;
	...
	ielmat1=ielmat;ielorien1=ielorien;norien1=norien;orab1=orab;
        ...
        ipobody1=ipobody;ibody1=ibody;xbody1=xbody;mpcon1=mpcon;
	nmpcon1=nmpcon;nmpmat1_=nmpmat_;vini1=vini;rdpcon1=rdpcon;gscon1=gscon;
        pphase1=pphase;cphase1=cphase;phaseother1=phaseother;nphase1=nphase;
	phase_inf1=phase_inf;
