...
!
     ...
     &  ialdesi,xdesi,mpcon,nmpcon,nmpmat_,rdpcon,gscon)
!
...
!
     ...
     &  iactive,icoordinate,ialdesi(*),ii,nmpcon(2,*),nmpmat_
!
     ...
     &  mpcon(2,nmpmat_,*),mpconloc(800),rdpcon(10,3,*),gscon(30,5,*),
