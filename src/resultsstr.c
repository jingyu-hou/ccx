...
static double *co1,*v1,*stx1,*elcon1,*rhcon1,*alcon1,*alzero1,*orab1,*t01,*t11,
    ...
    *thicke1,*emeini1,*prop1,*pslavsurf1,*pmastsurf1,*clearini1,*mpcon1,
    *rdpcon1,*gscon1;
...
void resultsstr(double *co,ITG *nk,ITG *kon,ITG *ipkon,char *lakon,ITG *ne,
       ...
       char *orname,ITG *network,ITG *neapar,ITG *nebpar,double *mpcon,
...
// next line is to be inserted in a similar way for all other paralell parts
	...
	nebpar1=nebpar;mpcon1=mpcon;nmpcon1=nmpcon;nmpmat1_=nmpmat_;
	rdpcon1=rdpcon;gscon1=gscon;
...
void *resultsmechmtstr(ITG *i){
    ...
    FORTRAN(resultsmech,(co1,kon1,ipkon1,lakon1,ne1,v1,
	  ...
	  kscale1,&list,ilist,mpcon1,nmpcon1,nmpmat1_,rdpcon1,gscon1));
