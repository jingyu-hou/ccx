...
!
     ...
     &  norien,nelem,mpcon,nmpcon,nmpmat_)
!
...
!
     ...
     &  norien,nelem,idof,idof1,idof2,iorien,nmpcon(2,*),nmpmat_
!
     ...
     &  xn1(3),xn2(3),a(3,3),mpcon(2,nmpmat_,*),mpconloc(800)
!
     ...
     &  nstate_,xstateini,reltime,nasym,mpcon,nmpcon,nmpmat_
!
