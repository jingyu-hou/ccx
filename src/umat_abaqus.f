...
!     ABAQUS and WeICME:
!
!     stran: in WeICME: Lagrangian strain tensor
!              in ABAQUS: logarithmic strain tensor
!     dstran: in WeICME: Lagrangian strain increment tensor
!              in ABAQUS: logarithmic strain increment tensor
!     temp:  in WeICME: temperature at the end of the increment
!              in ABAQUS: temperature at the start of the increment
!     dtemp: in WeICME: zero
