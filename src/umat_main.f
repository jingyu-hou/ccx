...
!
     ...
     &        beta,xikl,vij,xkl,vj,ithermal,t0l,t1l,dtime,time,ttime,
...
!
     ...
     &  vj,t0l,t1l,dtime,xkl(3,3),xikl(3,3),vij,pgauss(3),orab(7,*),
...
!
     ...
     &        nstate_,xstateini,xstate,stre,stiff,iorien,pgauss,orab)
!
!      elseif(amat(1:12).eq.'METAL_POWDER') then
!         amatloc(1:72)=amat(9:80)
!         amatloc(73:80)='        '
!         call umat_metal_powder(amatloc,iel,iint,kode,elconloc,emec,
!     &        emec0,beta,xikl,vij,xkl,vj,ithermal,t0l,t1l,dtime,time,
!     &        ttime,icmd,ielas,mi(1),nstate_,xstateini,xstate,stre,
